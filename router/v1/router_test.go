...
var (
	...
	mockPrices = math.LegacyDecCoins{
		sdk.NewDecCoinFromDec("ATOM", math.LegacyNewDecFromStr("34.84")),
		sdk.NewDecCoinFromDec("UMEE", math.LegacyNewDecFromStr("4.21")),
	}
)
...
func (m mockOracle) GetPrices() math.LegacyDecCoins {
	return mockPrices
}
