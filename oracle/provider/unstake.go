...
type (
	...
	UnstakeProvider struct {
		...
		periods   map[string]math.LegacyDec
...
func NewUnstakeProvider(
	...
	provider.periods = map[string]math.LegacyDec{}
...
func (p *UnstakeProvider) getRates(contract string) (math.LegacyDec, math.LegacyDec, error) {
	var ask, bid math.LegacyDec
