...
This is a standalone version of [Umee's fantastic work](https://github.com/umee-network/umee/tree/main/price-feeder) and [Kujira](https://github.com/Team-Kujira/oracle-price-feeder) migrating [Terra's oracle-feeder](https://github.com/terra-money/oracle-feeder) app to Go, and integrating it more closely with the Cosmos SDK.
...
To install the `price-feeder`, you can use the following command:
